                    ...
                    <button type="button" class="btn mb-2 btn-outline-success" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo">Cadastrar Nuevo Producto</button>
                      <div class="modal fade" id="varyModal" tabindex="-1" role="dialog" aria-labelledby="varyModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          ...
                          <form class="needs-validation" action="nuevoproducto.php" method="post">
                            ...
                            <div class="modal-footer">
                              <button type="submit" class="btn mb-2 btn-primary">Cadastrar Produto</button>
                              </form>
...
<?php
$sqlproduc="SELECT * FROM productos";
$result = mysqli_query($conexion, $sqlproduc);
...
?>
                          <tr>
                            ...
                            <td>
                             <a class="btn mb-2 btn-outline-info" href="editarproducto.php?id=<?php echo $mostrar['id'] ?>"><span class="fe fe-edit fe-16"></span></a>
                            </td>

                            <td>
                              <form action="eliminarproducto.php" method="post">
                              <input type="hidden" value="<?php echo $mostrar['id'] ?>" name="id_produc">
                              <button class="btn mb-2 btn-outline-danger" type="ubmit" name="btneliminar"><span class="fe fe-trash-2 fe-16"></span></button>
                              </form>
                            </td>
                            </tr>
<?php
