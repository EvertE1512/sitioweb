...
<?php
$idactual = $_GET["id"];
$sqltrans="SELECT * FROM transacciones WHERE id='$id'";
                ...
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                     <center> <strong class="h4 card-title">Editar Transaccion</strong> </center>
                    </div>
                    <div class="card-body">
                    <form class="needs-validation" action="procesar_editar_transacciones.php" method="post">
                        ...
                        <div class="form-group mb-4">
                          ...
                          <select class="form-control select2-multi" name="producto">
                        ...
                        <div class="form-group mb-3">
                          ...
                          <textarea class="form-control" name="descripccion" placeholder=""><?php echo $mostrar['descripccion'] ?></textarea>
                        </div>
                        
                        <div class="form-group mb-4">
                            <label for="validationCustom3">Valor</label>
                            <input type="number" class="form-control" name="valor" value="<?php echo $mostrar['valor'] ?>"> required>
                            <div class="valid-feedback"> Digite el valor </div>
                          </div>

                          <input type="hidden" name="id_trans" value="<?php echo $mostrar['id'] ?>">>
<?php
}
?>
