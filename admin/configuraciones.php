                ...
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                     <center> <strong class="h4 card-title">Configuraciones</strong> </center>
                    </div>
                    <div class="card-body">
                      <form class="needs-validation" novalidate>
                        ...
                        <div class="form-group mb-4">
                            <label for="validationCustom3">Contraseña Actual</label>
                            <input type="number" class="form-control" id="validationCustom3" value="">
                          </div>

                        <div class="form-group mb-4">
                            <label for="validationCustom3">Nueva Contraseña</label>
                            <input type="text" class="form-control" id="validationCustom3" value="" required>
                            <div class="valid-feedback"> Digite la Nueva Contraseña</div>
                          </div>
