...
<?php
$idactual = $_GET["id"];
$sqlproduc="SELECT * FROM productos WHERE id='$id'";
                ...
                <div class="col-md-6">
                  <div class="card shadow mb-4">
                    <div class="card-header">
                     <center> <strong class="h4 card-title">Editar Producto</strong> </center>
                    </div>
                    <div class="card-body">
                    <form class="needs-validation" action="procesar_editar_producto.php" method="post">
                        <div class="form-row"> </div>

                        <div class="form-group mb-3">
                          <label for="validationTextarea">Nombre</label>
                          <textarea class="form-control" name="nombre" placeholder=""><?php echo $mostrar['nombre'] ?></textarea>
                        </div>
                        ...
                        <div class="form-group mb-4">
                          ...
                          <input type="hidden" name="id_produc" value="<?php echo $mostrar['id'] ?>">>
<?php
}
?>
